...
public extension HexEntityColors {
    ...
    var secondary: Color { hex?.secondary ?? HexEntity.default.secondary }
    var onSecondary: Color { hex?.onSecondary ?? HexEntity.default.onSecondary }
    var secondaryContainer: Color { hex?.secondaryContainer ?? HexEntity.default.secondaryContainer }
    var onSecondaryContainer: Color { hex?.onSecondaryContainer ?? HexEntity.default.onSecondaryContainer }
    var tertiary: Color { hex?.tertiary ?? HexEntity.default.tertiary }
    var onTertiary: Color { hex?.onTertiary ?? HexEntity.default.onTertiary }
    var tertiaryContainer: Color { hex?.tertiaryContainer ?? HexEntity.default.tertiaryContainer }
    var onTertiaryContainer: Color { hex?.onTertiaryContainer ?? HexEntity.default.onTertiaryContainer }
    var error: Color { hex?.error ?? HexEntity.default.error }
    var onError: Color { hex?.onError ?? HexEntity.default.onError }
    var errorContainer: Color { hex?.errorContainer ?? HexEntity.default.errorContainer }
    var onErrorContainer: Color { hex?.onErrorContainer ?? HexEntity.default.onErrorContainer }
    var background: Color { hex?.background ?? HexEntity.default.background }
    var onBackground: Color { hex?.onBackground ?? HexEntity.default.onBackground }
    var surface: Color { hex?.surface ?? HexEntity.default.surface }
    var onSurface: Color { hex?.onSurface ?? HexEntity.default.onSurface }
    var surfaceVariant: Color { hex?.surfaceVariant ?? HexEntity.default.surfaceVariant }
    var onSurfaceVariant: Color { hex?.onSurfaceVariant ?? HexEntity.default.onSurfaceVariant }
    var outline: Color { hex?.outline ?? HexEntity.default.outline }
    var outlineVariant: Color { hex?.outlineVariant ?? HexEntity.default.outlineVariant }
    var shadow: Color { hex?.shadow ?? HexEntity.default.shadow }
    var scrim: Color { hex?.scrim ?? HexEntity.default.scrim }
    var inverseSurface: Color { hex?.inverseSurface ?? HexEntity.default.inverseSurface }
    ...
    var lightSecondary: Color {
        Color(argb: hex?.light.secondary ?? HexEntity.default.light.secondary)
    }

    var lightOnSecondary: Color {
        Color(argb: hex?.light.onSecondary ?? HexEntity.default.light.onSecondary)
    }

    var lightSecondaryContainer: Color {
        Color(argb: hex?.light.secondaryContainer ?? HexEntity.default.light.secondaryContainer)
    }

    var lightOnSecondaryContainer: Color {
        Color(argb: hex?.light.onSecondaryContainer ?? HexEntity.default.light.onSecondaryContainer)
    }

    var lightTertiary: Color {
        Color(argb: hex?.light.tertiary ?? HexEntity.default.light.tertiary)
    }

    var lightOnTertiary: Color {
        Color(argb: hex?.light.onTertiary ?? HexEntity.default.light.onTertiary)
    }

    var lightTertiaryContainer: Color {
        Color(argb: hex?.light.tertiaryContainer ?? HexEntity.default.light.tertiaryContainer)
    }

    var lightOnTertiaryContainer: Color {
        Color(argb: hex?.light.onTertiaryContainer ?? HexEntity.default.light.onTertiaryContainer)
    }

    var lightError: Color {
        Color(argb: hex?.light.error ?? HexEntity.default.light.error)
    }

    var lightOnError: Color {
        Color(argb: hex?.light.onError ?? HexEntity.default.light.onError)
    }

    var lightErrorContainer: Color {
        Color(argb: hex?.light.errorContainer ?? HexEntity.default.light.errorContainer)
    }

    var lightOnErrorContainer: Color {
        Color(argb: hex?.light.onErrorContainer ?? HexEntity.default.light.onErrorContainer)
    }

    var lightBackground: Color {
        Color(argb: hex?.light.background ?? HexEntity.default.light.background)
    }

    var lightOnBackground: Color {
        Color(argb: hex?.light.onBackground ?? HexEntity.default.light.onBackground)
    }

    var lightSurface: Color {
        Color(argb: hex?.light.surface ?? HexEntity.default.light.surface)
    }

    var lightOnSurface: Color {
        Color(argb: hex?.light.onSurface ?? HexEntity.default.light.onSurface)
    }

    var lightSurfaceVariant: Color {
        Color(argb: hex?.light.surfaceVariant ?? HexEntity.default.light.surfaceVariant)
    }

    var lightOnSurfaceVariant: Color {
        Color(argb: hex?.light.onSurfaceVariant ?? HexEntity.default.light.onSurfaceVariant)
    }

    var lightOutline: Color {
        Color(argb: hex?.light.outline ?? HexEntity.default.light.outline)
    }

    var lightOutlineVariant: Color {
        Color(argb: hex?.light.outlineVariant ?? HexEntity.default.light.outlineVariant)
    }

    var lightShadow: Color {
        Color(argb: hex?.light.shadow ?? HexEntity.default.light.shadow)
    }

    var lightScrim: Color {
        Color(argb: hex?.light.scrim ?? HexEntity.default.light.scrim)
    }

    var lightInverseSurface: Color {
        Color(argb: hex?.light.inverseSurface ?? HexEntity.default.light.inverseSurface)
    }

    var lightOnInverseSurface: Color {
        Color(argb: hex?.light.onInverseSurface ?? HexEntity.default.light.onInverseSurface)
    }

    var lightInversePrimary: Color {
        Color(argb: hex?.light.inversePrimary ?? HexEntity.default.light.inversePrimary)
    }
    ...
    var darkSecondary: Color {
        Color(argb: hex?.dark.secondary ?? HexEntity.default.dark.secondary)
    }

    var darkOnSecondary: Color {
        Color(argb: hex?.dark.onSecondary ?? HexEntity.default.dark.onSecondary)
    }

    var darkSecondaryContainer: Color {
        Color(argb: hex?.dark.secondaryContainer ?? HexEntity.default.dark.secondaryContainer)
    }

    var darkOnSecondaryContainer: Color {
        Color(argb: hex?.dark.onSecondaryContainer ?? HexEntity.default.dark.onSecondaryContainer)
    }

    var darkTertiary: Color {
        Color(argb: hex?.dark.tertiary ?? HexEntity.default.dark.tertiary)
    }

    var darkOnTertiary: Color {
        Color(argb: hex?.dark.onTertiary ?? HexEntity.default.dark.onTertiary)
    }

    var darkTertiaryContainer: Color {
        Color(argb: hex?.dark.tertiaryContainer ?? HexEntity.default.dark.tertiaryContainer)
    }

    var darkOnTertiaryContainer: Color {
        Color(argb: hex?.dark.onTertiaryContainer ?? HexEntity.default.dark.onTertiaryContainer)
    }

    var darkError: Color {
        Color(argb: hex?.dark.error ?? HexEntity.default.dark.error)
    }

    var darkOnError: Color {
        Color(argb: hex?.dark.onError ?? HexEntity.default.dark.onError)
    }

    var darkErrorContainer: Color {
        Color(argb: hex?.dark.errorContainer ?? HexEntity.default.dark.errorContainer)
    }

    var darkOnErrorContainer: Color {
        Color(argb: hex?.dark.onErrorContainer ?? HexEntity.default.dark.onErrorContainer)
    }

    var darkBackground: Color {
        Color(argb: hex?.dark.background ?? HexEntity.default.dark.background)
    }

    var darkOnBackground: Color {
        Color(argb: hex?.dark.onBackground ?? HexEntity.default.dark.onBackground)
    }

    var darkSurface: Color {
        Color(argb: hex?.dark.surface ?? HexEntity.default.dark.surface)
    }

    var darkOnSurface: Color {
        Color(argb: hex?.dark.onSurface ?? HexEntity.default.dark.onSurface)
    }

    var darkSurfaceVariant: Color {
        Color(argb: hex?.dark.surfaceVariant ?? HexEntity.default.dark.surfaceVariant)
    }

    var darkOnSurfaceVariant: Color {
        Color(argb: hex?.dark.onSurfaceVariant ?? HexEntity.default.dark.onSurfaceVariant)
    }

    var darkOutline: Color {
        Color(argb: hex?.dark.outline ?? HexEntity.default.dark.outline)
    }

    var darkOutlineVariant: Color {
        Color(argb: hex?.dark.outlineVariant ?? HexEntity.default.dark.outlineVariant)
    }

    var darkShadow: Color {
        Color(argb: hex?.dark.shadow ?? HexEntity.default.dark.shadow)
    }

    var darkScrim: Color {
        Color(argb: hex?.dark.scrim ?? HexEntity.default.dark.scrim)
    }

    var darkInverseSurface: Color {
        Color(argb: hex?.dark.inverseSurface ?? HexEntity.default.dark.inverseSurface)
    }

    var darkOnInverseSurface: Color {
        Color(argb: hex?.dark.onInverseSurface ?? HexEntity.default.dark.onInverseSurface)
    }
