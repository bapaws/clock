        ...
        for prop in o.objectSchema.properties {
            ...
            if prop.isArray {
                ...
                case .date:
                    ...
                    recordValue = list
                case .objectId:
                    guard let value = record.value(forKey: prop.name) as? [ObjectId] else { break }
            ...
            case .objectId:
                ...
                if let string = record.value(forKey: name) as? String {
                    recordValue = try? ObjectId(string: string)
                }
            case .object:
