//
//  DigitalPomodoroPortraitView.swift
//  DigitalClock
//
...
struct DigitalPomodoroPortraitView: View {
    let time: Time
    let color: Colors
...
#Preview {
    DigitalPomodoroPortraitView(time: PomodoroManager.shared.time, color: ColorType.classic.colors)
}
